...
public class GenLayerTest extends GenLayer
{
    ...
    public GenLayerTest(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkGeneratorSettings p_i45560_5_)
    {
        super(p_i45560_1_);
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i = 0; i < areaHeight; ++i)
        {
            for (int j = 0; j < areaWidth; ++j)
            {
                ...
                else if (k == Biome.getIdForBiome(ModBiomes.PATAGONIA))
                {
                ...
                else if (k == 1)
                {
                    if (l > 0)
                    {
                        if (this.nextInt(3) == 0)
                        {
                            aint1[j + i * areaWidth] = Biome.getIdForBiome(ModBiomes.PATAGONIA);
                        }
                        else
                        {
                            aint1[j + i * areaWidth] = Biome.getIdForBiome(ModBiomes.PATAGONIA);
