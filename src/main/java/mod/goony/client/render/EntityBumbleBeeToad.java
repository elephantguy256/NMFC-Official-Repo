...
public class EntityBumbleBeeToad extends EntityAnimal
{
    private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager.<Integer>createKey(EntityBumbleBeeToad.class, DataSerializers.VARINT);
    ...
    public EntityBumbleBeeToad(World worldIn)
    {
        ...
        this.jumpHelper = new EntityBumbleBeeToad.RabbitJumpHelper(this);
        this.moveHelper = new EntityBumbleBeeToad.RabbitMoveHelper(this);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(1, new EntityBumbleBeeToad.AIPanic(this, 2.2D));
        ...
        this.tasks.addTask(4, new EntityBumbleBeeToad.AIAvoidEntity(this, EntityPlayer.class, 8.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new EntityBumbleBeeToad.AIAvoidEntity(this, EntityWolf.class, 10.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new EntityBumbleBeeToad.AIAvoidEntity(this, EntityMob.class, 4.0F, 2.2D, 2.2D));
        this.tasks.addTask(5, new EntityBumbleBeeToad.AIRaidFarm(this));
    ...
    public void updateAITasks()
    {
        ...
        if (this.onGround)
        {
            ...
            EntityBumbleBeeToad.RabbitJumpHelper entityrabbit$rabbitjumphelper = (EntityBumbleBeeToad.RabbitJumpHelper)this.jumpHelper;
    ...
    {
        ((EntityBumbleBeeToad.RabbitJumpHelper)this.jumpHelper).setCanJump(true);
    }

    private void disableJumpControl()
    {
        ((EntityBumbleBeeToad.RabbitJumpHelper)this.jumpHelper).setCanJump(false);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityBumbleBeeToad.class);
    }
    ...
    public EntityBumbleBeeToad createChild(EntityAgeable ageable)
    {
        EntityBumbleBeeToad entityrabbit = new EntityBumbleBeeToad(this.world);
        int i = this.getRandomRabbitType();

        if (this.rand.nextInt(20) != 0)
        {
            if (ageable instanceof EntityBumbleBeeToad && this.rand.nextBoolean())
            {
                i = ((EntityBumbleBeeToad)ageable).getRabbitType();
            }
            else
            {
    ...
    public void setRabbitType(int rabbitTypeId)
    {
        if (rabbitTypeId == 99)
        {
            ...
            this.tasks.addTask(4, new EntityBumbleBeeToad.AIEvilAttack(this));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntityBumbleBeeToad.RabbitTypeData)
        {
            i = ((EntityBumbleBeeToad.RabbitTypeData)livingdata).typeData;
            flag = true;
        }
        else
        {
            livingdata = new EntityBumbleBeeToad.RabbitTypeData(i);
        }
    ...
    static class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T>
        {
            private final EntityBumbleBeeToad rabbit;

            public AIAvoidEntity(EntityBumbleBeeToad rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_)
            {
    ...
    static class AIEvilAttack extends EntityAIAttackMelee
        {
            public AIEvilAttack(EntityBumbleBeeToad rabbit)
            {
    ...
    static class AIPanic extends EntityAIPanic
        {
            ...
            public AIPanic(EntityBumbleBeeToad rabbit, double speedIn)
            {
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
        {
            ...
            public AIRaidFarm(EntityBumbleBeeToad rabbitIn)
            {
    ...
    public class RabbitJumpHelper extends EntityJumpHelper
    {
        ...
        public RabbitJumpHelper(EntityBumbleBeeToad rabbit)
        {
            super(rabbit);
            this.rabbit = rabbit;
        }
    ...
    static class RabbitMoveHelper extends EntityMoveHelper
        {
            ...
            public RabbitMoveHelper(EntityBumbleBeeToad rabbit)
            {
                super(rabbit);
                this.rabbit = rabbit;
            }
            ...
            {
                if (this.rabbit.onGround && !this.rabbit.isJumping && !((EntityBumbleBeeToad.RabbitJumpHelper)this.rabbit.jumpHelper).getIsJumping())
                {
