...
public class EntityViscacha extends EntityTameable
{

    private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityViscacha.class, DataSerializers.VARINT);
    private EntityAIAvoidEntity<EntityPlayer> avoidEntity;
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;
	private boolean calling;

    public EntityViscacha(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityPuma.class, 16.0F, 0.8D, 1.33D));
        this.tasks.addTask(3, new EntityAIAvoidEntity(this, EntityPampasFox.class, 16.0F, 0.8D, 1.33D));
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityViscacha.class);
    }
    ...
    public EntityViscacha createChild(EntityAgeable ageable)
    {
        EntityViscacha entityocelot = new EntityViscacha(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityViscacha))
        {
            return false;
        }
        else
        {
            EntityViscacha entityocelot = (EntityViscacha)otherAnimal;
    ...
    {
        return this.world.rand.nextInt(4) != 0;
    }
    ...
    public String getName()
    {
        ...
        {
            return this.isTamed() ? I18n.translateToLocal("entity.Chinchilla.name") : super.getName();
        }
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (this.getTameSkin() == 0 && this.world.rand.nextInt(4) == 0)
        {
            for (int i = 0; i < 2; ++i)
            {
                EntityViscacha entityocelot = new EntityViscacha(this.world);
