...
public class EntityPumaCub extends EntityPuma
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityPumaCub.class, DataSerializers.FLOAT);
    private static final DataParameter<Boolean> BEGGING = EntityDataManager.<Boolean>createKey(EntityPumaCub.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.<Integer>createKey(EntityPumaCub.class, DataSerializers.VARINT);
    ...
    public EntityPumaCub(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.targetTasks.addTask(5, new EntityAITargetNonTamed(this, EntityPumaCub.class, false, (Predicate)null));
        this.targetTasks.addTask(5, new EntityAINearestAttackableTarget(this, EntityPuma.class, false));
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getAttributeMap().registerAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(0D);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityPumaCub.class);
    }
    ...
    public void setTamed(boolean i)
    {
        super.setTamed(i);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityPumaCub))
        {
            return false;
        }
        else
        {
            EntityPumaCub entitywolf = (EntityPumaCub)otherAnimal;
    ...
    public boolean shouldAttackEntity(EntityLivingBase target, EntityLivingBase owner)
    {
        ...
        {
            if (target instanceof EntityPumaCub)
            {
                EntityPumaCub entitywolf = (EntityPumaCub)target;
    ...
    {
        private final EntityPumaCub wolf;

        public AIAvoidEntity(EntityPumaCub wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityPumaCub.this.rand.nextInt(5);
        }
        ...
        {
            EntityPumaCub.this.setAttackTarget((EntityLivingBase)null);
	...
	public void setTamed(int tameSkin) {
