...
public class EntityAndeanGoose extends EntityAnimal
{
    ...
    public EntityAndeanGoose(World worldIn)
    {
        super(worldIn);
    ...
    public EntityAndeanGoose createChild(EntityAgeable ageable)
    {
        return new EntityAndeanGoose(this.world);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityAndeanGoose.class);
    }
