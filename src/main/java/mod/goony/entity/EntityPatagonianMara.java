...
public class EntityPatagonianMara extends EntityTameable
{
    public class AIAvoidEntity extends EntityAIBase {

		public AIAvoidEntity(EntityPatagonianMara entityPampasFox, Class<EntityPuma> class1, float f, double d, double e) {
	...
	public class AISpiderTarget extends EntityAIBase {
		...
		public AISpiderTarget(EntityPatagonianMara entityPuma, Class<EntityPlayer> class1) {
			// TODO Auto-generated constructor stub
		}
	...
	private static final DataParameter<Integer> OCELOT_VARIANT = EntityDataManager.<Integer>createKey(EntityPatagonianMara.class, DataSerializers.VARINT);
    private EntityAIAvoidEntity<EntityPlayer> avoidEntity;
    /** The tempt AI task for this mob, used to prevent taming while it is fleeing. */
    private EntityAITempt aiTempt;

    public EntityPatagonianMara(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(12, new EntityPatagonianMara.AIAvoidEntity(this, EntityPuma.class, 8.0F, 2.2D, 2.2D));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityPatagonianMara.class);
    }
    ...
    public EntityPatagonianMara createChild(EntityAgeable ageable)
    {
        EntityPatagonianMara entityocelot = new EntityPatagonianMara(this.world);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        else if (!(otherAnimal instanceof EntityPatagonianMara))
        {
            return false;
        }
        else
        {
            EntityPatagonianMara entityocelot = (EntityPatagonianMara)otherAnimal;
