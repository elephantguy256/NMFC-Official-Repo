...
public class NMFCBiomeDecorator
{
    ...
    public WorldGenerator pgrassGen = new WorldGenSand(ModBlocks.pgrass, 6);
    public WorldGenerator prshrubGen = new WorldGenSand(ModBlocks.pshrub, 6);
    public WorldGenerator LupineGen = new WorldGenSand(ModBlocks.lupine, 6);
    /** The dirt generator. */
	...
	public int lupineperchunk;
	public int pgrassperchunk;

    public void decorate(World worldIn, Random random, Biome nmfcBiome, BlockPos pos)
    {
        if (this.decorating)
        {
        ...
        else
        {
            ...
            this.genDecorations(nmfcBiome, worldIn, random);
            this.decorating = false;
        }
    }

    protected void genDecorations(Biome nmfcBiome, World worldIn, Random random)
    {
        ...
        for (int j2 = 0; j2 < k1; ++j2)
        {
            ...
            WorldGenAbstractTree worldgenabstracttree = nmfcBiome.getRandomTreeFeature(random);
        ...
        for (int l2 = 0; l2 < this.flowersPerChunk; ++l2)
        {
            ...
            if (j14 > 0)
            {
                ...
                BlockFlower.EnumFlowerType blockflower$enumflowertype = nmfcBiome.pickRandomFlower(random, blockpos1);
        ...
        for (int i3 = 0; i3 < this.grassPerChunk; ++i3)
        {
            ...
            if (k14 > 0)
            {
                ...
                nmfcBiome.getRandomWorldGenForGrass(random).generate(worldIn, random, this.chunkPos.add(j7, l17, i11));
            }
        }
        ...
        for (int j3 = 0; j3 < this.pgrassperchunk; ++j3)
        {
            ...
            if (l14 > 0)
            {
                ...
                (new WorldGenPatagonianGrass()).generate(worldIn, random, this.chunkPos.add(k7, i18, j11));
            }
        }
        
        if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, random, chunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.DEAD_BUSH))
        for (int j3 = 0; j3 < this.shrubperchunk; ++j3)
        {
            int k7 = random.nextInt(16) + 8;
            int j11 = random.nextInt(16) + 8;
            int l14 = worldIn.getHeight(this.chunkPos.add(k7, 0, j11)).getY() * 2;
            ...
            {
                int i18 = random.nextInt(l14);
                (new WorldGenPatagonianShrub()).generate(worldIn, random, this.chunkPos.add(k7, i18, j11));
            }
        }
        
        if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, random, chunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.DEAD_BUSH))
        for (int j3 = 0; j3 < this.lupineperchunk; ++j3)
        {
            int k7 = random.nextInt(16) + 8;
            int j11 = random.nextInt(16) + 8;
            int l14 = worldIn.getHeight(this.chunkPos.add(k7, 0, j11)).getY() * 2;
            ...
            {
                int i18 = random.nextInt(l14);
                (new WorldGenLupine()).generate(worldIn, random, this.chunkPos.add(k7, i18, j11));
            }
        }
