...
public class ModelChinchilla extends ModelBase {
    ...
    public ModelChinchilla() {
        ...
        this.FrontRightLeg1.setRotationPoint(5.7F, -0.6F, 5.0F);
        ...
        this.FrontLeftLeg1.setRotationPoint(0.3F, -0.6F, 5.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.BackRightLegAnimationC.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    }
    }