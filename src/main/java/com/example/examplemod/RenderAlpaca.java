...
{
    private static final ResourceLocation[] LLAMA_TEXTURES = new ResourceLocation[] {new ResourceLocation("de:textures/entity/preyanimal/alpaca1.png"), new ResourceLocation("de:textures/entity/preyanimal/alpaca2.png"), new ResourceLocation("de:textures/entity/preyanimal/alpaca1.png"), new ResourceLocation("de:textures/entity/preyanimal/alpaca1.png")};
